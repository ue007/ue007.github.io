      ...
      },
      {
        ...
        titleWrapper: {
          ...
          children: [
            ...
            { name: "title", children: "Fujie", className: "teams0-h1" },
            {
              name: "content2",
              children: "",
              className: "teams0-content",
    ...
    children: [
      {
        ...
        children: {
          ...
          name: { className: "block-name", children: "Increate" },
          post: { className: "block-post", children: "Indeco" },
          time: { className: "block-time", children: "2021.06 - 2021.08" },
          title: {
            className: "block-title",
            children: "Generative Design = AI + Design + 3D",
          },
          content: {
            className: "block-content",
            children:
              "Tech Stack：cad、datasmith、ai、editor、gltf、blueprintjs、pixi、three",
          },
        },
      },
      {
        ...
        children: {
          ...
          name: { className: "block-name", children: "blood4cad" },
          post: { className: "block-post", children: "blood" },
          time: { className: "block-time", children: "2021.04 - 至今" },
          title: {
            className: "block-title",
            children: "Blood4CAD = CAD + DataSmith + 2D + 3D",
          },
          content: {
            className: "block-content",
            children:
              "Tech Stack： dxf-serializer、dxf-deserializer、algorithm",
          },
        },
      },
      {
...
export const Footer20DataSource = {
  ...
  links: {
    ...
    children: [
      ...
      {
        name: "zhihu",
        href: "https://www.zhihu.com/people/ue007/columns",
